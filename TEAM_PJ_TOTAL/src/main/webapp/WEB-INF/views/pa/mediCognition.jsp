...
<!-- container -->
  ...
  <!-- 이미지 : 글씨도 이미지입니다. 이미지 크기 늘리면 깨져용!  -->
  <div class="medicogn" style="background-color:#BCE1EA;"><img src="resources/img/medicogni.png"></div>
  
  <div class="medicogn"> 
  	<h3 style="margin-left:280px; font-size:1.8em; margin-top:50px"> 약품 인식 서비스 이용하기 </h3> 
  </div>
