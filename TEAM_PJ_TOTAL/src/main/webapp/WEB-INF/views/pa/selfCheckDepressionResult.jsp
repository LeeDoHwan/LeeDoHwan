...
<!-- container -->
	<div class="container">
	    ...
	    <div align="center">
		    <form action="depressionResultPro.pa" method="post">
		    <input type = "hidden" name="${_csrf.parameterName}" value="${_csrf.token}"> 
				<input type="hidden" name="depScore" value="${depScore}">
 			    <table class="table table-bordered table-striped">
				  	...
				  	<tr>
				  		<td colspan="2"><br>점수 : ${depScore} 점</td>
				  	</tr> 
					<c:if test="${depScore < 16}">
					  	<tr>
					  		<td colspan="2">
					 ...
					 <c:if test="${depScore < 25 && depScore >= 16}">
					  	<tr>
					  		<td colspan="2">
					  			<p id="message">우울증 경증이 의심됩니다. 전문가의 정확한 진단을 권장합니다.</p>
					  			<input type="hidden" name="message" value="우울증 경증이 의심됩니다. 전문가의 정확한 진단을 권장합니다.">
					  			<div align="right">
					  				<input type="submit" class="btn btn-info" name="제출하기">
					  			</div>
					  		</td>
					 ...
					 <c:if test="${depScore >= 25}">
					  	<tr>
					  		<td colspan="2">
					  			<p id="message">우울증 중증이 의심됩니다. 정신건강 센터 방문을 권장합니다.</p>
					  			<input type="hidden" name="message" value="우울증 중증이 의심됩니다. 정신건강 센터 방문을 권장합니다.">
					  			<div align="right">
					  				<input type="submit" class="btn btn-info" name="제출하기">
					  			</div>
					  		</td>
