...
<!-- msg start  -->
      	 <div class="row">
       	    <div class="col">
       	        <p class="text-white mt-5 mb-5"> <b>공지작성</b> </p>
       	    </div>
     	 </div>
<!-- msg close -->
			...
			<div class="span15" align="center">
			 <div class="widget-box" align="center">
			        ...
			        <div class="widget-content nopadding" >
			          <form action="boardWritePro.ho" method="get" class="form-horizontal">
			          <input type = "hidden" name = "${_csrf.parameterName}" value = "${_csrf.token}">
			            <div class="control-group">
			              <label class="control-label">제목 :</label>
			              <div class="controls">
			                <input type="text" class="span8" placeholder="제목" name="subject"/>
			              </div>
			            </div>
			            <div class="control-group">
			              <label class="control-label">Message</label>
			              <div class="controls">
			                <textarea class="span8" style="height:400px;" name="content"></textarea>
			              </div>
			            </div>
